...
const addEmployee = (name, username, password, role_id,  email, phone, branch_id) => {
  return pool.query(
    "INSERT INTO employee (name, username, password, role_id,  email, phone, branch_id) values ($1, $2, $3, $4, $5 , $6,$7) returning *",
    [name, username, password, role_id,  email, phone, branch_id]
  );
};

const updateEmployee = (id, name, username, password, role_id,  email, phone, branch_id) => {
  return pool.query(
