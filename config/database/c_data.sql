...
INSERT INTO product (name, description, category_ID, image, unit_id, buying_ppu, retail_ppu, supplier_ID, barcode, created_on, updated_on)
VALUES
    ('Munchee Cream Cracker 100g', 'Delicious cream cracker biscuits from Munchee. Ideal for snacking.', 5, 'https://example.com/munchee-cream-cracker.jpg', 15, 50.00, 70.00, 1, '1234567890123',  '2022-03-10', '2023-07-05'),
    ('Ceylon Tea Leaves 250g', 'Premium Ceylon tea leaves for a perfect cup of tea. Made by Ceylon Tea Company.', 6, 'https://example.com/ceylon-tea.jpg', 15, 200.00, 250.00, 2, '9876543210987',  '2022-04-20', '2023-07-10'),
    ('Samba Rice 5kg', 'High-quality Samba rice for traditional Sri Lankan dishes. Rice King brand.', 6, 'https://example.com/rice.jpg', 15, 350.00, 400.00, 3, '2345678901234', '2022-05-15', '2023-08-01'),
    ('CocoLife Coconut Oil 1L', 'Pure coconut oil for cooking and skincare. CocoLife brand.', 7, 'https://example.com/coconut-oil.jpg', 15, 300.00, 400.00, 4, '3456789012345',  '2022-06-10', '2023-09-05'),
    ('Lucky Canned Fish 400g', 'Canned fish in brine, a convenient source of protein. Lucky brand.', 8, 'https://example.com/canned-fish.jpg', 15, 150.00, 180.00, 5, '4567890123456',  '2022-07-05', '2023-07-15'),
    ('Sunsilk Shampoo 250ml', 'Gentle shampoo for clean and healthy hair. Sunsilk brand.', 9, 'https://example.com/shampoo.jpg', 15, 150.00, 200.00, 6, '5678901234567',  '2022-08-20', '2023-08-25'),
    ('Nescafe Instant Coffee 100g', 'Instant coffee for a quick caffeine boost. Nescafe brand.', 6, 'https://example.com/nescafe-coffee.jpg', 15, 180.00, 220.00, 7, '6789012345678',  '2022-09-15', '2023-09-10'),
    ('Lipton Yellow Label Tea 100 bags', 'Lipton Yellow Label tea bags for a refreshing brew. Lipton brand.', 6, 'https://example.com/lipton-tea.jpg', 15, 150.00, 180.00, 8, '7890123456789',  '2022-10-20', '2023-07-01'),
    ('Maggi Instant Noodles 75g', 'Quick and tasty Maggi instant noodles. Maggi brand.', 7, 'https://example.com/maggi-noodles.jpg', 15, 30.00, 40.00, 9, '8901234567890', '2022-11-25', '2023-08-20'),
    ('Colgate Toothpaste 150g', 'Colgate toothpaste for healthy teeth. Colgate brand.', 10, 'https://example.com/colgate-toothpaste.jpg', 14, 120.00, 150.00, 10, '9012345670901', '2022-12-10', '2023-09-01'),
    ('Dettol Liquid Hand Wash 250ml', 'Dettol liquid hand wash for germ protection. Dettol brand.', 10, 'https://example.com/dettol-hand-wash.jpg', 14, 50.00, 60.00, 11, '1123456789012',  '2023-01-15', '2023-07-10'),
    ('Sunlight Dishwashing Liquid 500ml', 'Sunlight dishwashing liquid for clean dishes. Sunlight brand.', 7, 'https://example.com/sunlight-dishwash.jpg', 14, 80.00, 100.00, 12, '1234567891123',  '2023-02-20', '2023-08-15'),
    ('Palmolive Shower Gel 250ml', 'Palmolive shower gel for a refreshing shower. Palmolive brand.', 10, 'https://example.com/palmolive-shower-gel.jpg', 14, 60.00, 80.00, 13, '2341678901234', '2023-03-10', '2023-09-20'),
    ('Whisper Ultra Thin Sanitary Pads 10s', 'Whisper Ultra Thin sanitary pads for comfortable protection. Whisper brand.', 11, 'https://example.com/whisper-sanitary-pads.jpg', 14, 100.00, 120.00, 14, '1456789012345', '2023-04-15', '2023-08-25'),
    ('Kotex Maxi Pads 16s', 'Kotex Maxi pads for reliable menstrual protection. Kotex brand.', 11, 'https://example.com/kotex-maxi-pads.jpg', 14, 80.00, 100.00, 15, '4567891123456',  '2023-05-20', '2023-07-05'),
    ('Ariel Laundry Detergent 2kg', 'Ariel laundry detergent for clean and fresh clothes. Ariel brand.', 12, 'https://example.com/ariel-detergent.jpg', 14, 250.00, 300.00, 16, '5678911234567', '2023-06-25', '2023-09-10'),
    ('Pears Baby Soap', 'Gentle and mild baby soap from Pears. Suitable for delicate skin.', 11, 'https://example.com/pears-baby-soap.jpg', 13, 75.00, 100.00, 1, '1234567890124',  '2023-07-30', '2023-08-15'),
    ('Duracell AA Batteries 4-pack', 'Duracell AA batteries for long-lasting power. Duracell brand.', 13, 'https://example.com/duracell-batteries.jpg', 13, 80.00, 100.00, 18, '7895123456789', '2023-08-05', '2023-08-20'),
    ('Sony Earphones', 'High-quality Sony earphones for music lovers. Sony brand.', 14, 'https://example.com/sony-earphones.jpg', 12, 350.00, 400.00, 19, '8911234567890',  '2023-09-10', '2023-09-25'),
    ('Nike Running Shoes', 'Nike running shoes for active lifestyles. Nike brand.', 15, 'https://example.com/nike-running-shoes.jpg', 17, 500.00, 600.00, 20, '9012345671901',  '2023-09-25', '2023-09-30'),
    ('IKEA Table Lamp', 'IKEA table lamp for stylish illumination. IKEA brand.', 16, 'https://example.com/ikea-table-lamp.jpg', 17, 120.00, 150.00, 1, '2123456789012', '2023-10-05', '2023-10-10'),
    ('Harry Potter and the Sorcerer''s Stone', 'A classic novel by J.K. Rowling. Genre: Fantasy. Author: J.K. Rowling.', 19, 'https://example.com/harry-potter-book.jpg', 20, 20.00, 25.00, 2, '1234567890193',  '2023-10-15', '2023-10-20'),
    ('Lego Star Wars Millennium Falcon', 'Build the iconic Millennium Falcon with LEGO. Theme: Star Wars. Brand: LEGO.', 19, 'https://example.com/lego-millennium-falcon.jpg', 20, 300.00, 350.00, 3, '2342678901234',  '2023-10-25', '2023-10-30'),
    ('Wilson Tennis Racket', 'Wilson tennis racket for tennis enthusiasts. Brand: Wilson. Sport: Tennis.', 20, 'https://example.com/wilson-tennis-racket.jpg', 1, 100.00, 120.00, 4, '2456789012345',  '2023-11-05', '2023-11-10'),
    ('Castrol Engine Oil 1L', 'Castrol engine oil for smooth performance. Castrol brand. Vehicle: Car.', 21, 'https://example.com/castrol-engine-oil.jpg', 20, 80.00, 100.00, 5, '1567892123456', '2023-11-15', '2023-11-20'),
    ('Gold Necklace', 'Elegant gold necklace for special occasions. Jewelry Type: Necklace. Material: Gold.', 22, 'https://example.com/gold-necklace.jpg', 2, 1000.00, 1200.00, 6, '2678921234567', '2023-11-25', '2023-11-30'),
    ('Staedtler Colored Pencils 24-pack', 'Staedtler colored pencils for creative art projects. Brand: Staedtler. Quantity: 24.', 24, 'https://example.com/staedtler-colored-pencils.jpg', 3, 50.00, 60.00, 7, '3789112345678',  '2023-12-05', '2023-12-10'),
    ('Acrylic Paint Set 12 Colors', 'Acrylic paint set for painting enthusiasts. Quantity: 12 colors.', 24, 'https://example.com/acrylic-paint-set.jpg', 3, 40.00, 50.00, 8, '4894123456789',  '2023-12-15', '2023-12-20'),
    ('Ford Mustang Model Car Kit', 'Build your own Ford Mustang model car kit. Brand: Ford. Scale: 1:24.', 25, 'https://example.com/ford-mustang-model-kit.jpg', 4, 60.00, 80.00, 10, '5921234567890',  '2023-12-25', '2023-12-30'),
    ('Yamaha Acoustic Guitar', 'Yamaha acoustic guitar for musicians. Brand: Yamaha. Type: Acoustic.', 25, 'https://example.com/yamaha-acoustic-guitar.jpg', 4, 200.00, 250.00, 1, '9012345672901', '2024-01-05', '2024-01-10'),
    ('Adidas Sports Shoes', 'Adidas sports shoes for active lifestyles. Brand: Adidas. Sport: Running.', 6, 'https://example.com/adidas-sports-shoes.jpg', 7, 400.00, 500.00, 2, '3123456789012', '2024-01-15', '2024-01-20'),
    ('Samsung 55-inch 4K Smart TV', 'Samsung 55-inch 4K Smart TV for immersive entertainment. Brand: Samsung. Screen Size: 55 inches.', 8, 'https://example.com/samsung-4k-smart-tv.jpg', 5, 900.00, 1100.00, 13, '1234567890122', '2024-01-25', '2024-01-30'),
    ('Levi''s Denim Jeans', 'Levi''s denim jeans for classic style. Brand: Levi''s. Type: Jeans.', 9, 'https://example.com/levis-jeans.jpg', 5, 150.00, 180.00, 14, '2345878901234', '2024-02-05', '2024-02-10'),
    ('Home Decor Wall Clock', 'Elegant wall clock for home decor. Type: Wall Clock. Style: Elegant.', 7, 'https://example.com/home-decor-wall-clock.jpg', 6, 40.00, 50.00, 15, '4456789012345',  '2024-02-15', '2024-02-20'),
    ('Cooking for Dummies Book', 'Cooking for Dummies book for aspiring chefs. Genre: Cooking. Author: John Doe.', 19, 'https://example.com/cooking-for-dummies-book.jpg', 8, 15.00, 20.00, 16, '3567892123456', '2024-02-25', '2024-02-28'),
    ('LEGO Creator Expert Roller Coaster', 'Build the LEGO Creator Expert Roller Coaster for fun and excitement. Theme: Amusement Park. Brand: LEGO.', 19, 'https://example.com/lego-roller-coaster.jpg', 2, 400.00, 500.00, 17, '4678901234567',  '2024-03-05', '2024-03-10'),
    ('Wilson Tennis Balls 3-pack', 'Wilson tennis balls for tennis practice and matches. Brand: Wilson. Quantity: 3.', 20, 'https://example.com/wilson-tennis-balls.jpg', 9, 20.00, 25.00, 18, '5789212345678', '2024-03-15', '2024-03-20'),
    ('Castrol Motorcycle Oil 1L', 'Castrol motorcycle oil for smooth engine performance. Castrol brand. Vehicle: Motorcycle.', 21, 'https://example.com/castrol-motorcycle-oil.jpg', 4, 60.00, 80.00, 19, '7893123456789',  '2024-03-25', '2024-03-30'),
    ('Gold Earrings', 'Elegant gold earrings for special occasions. Jewelry Type: Earrings. Material: Gold.', 22, 'https://example.com/gold-earrings.jpg', 1, 800.00, 1000.00, 20, '8931234567890', '2024-04-05', '2024-04-10'),
    ('Faber-Castell Watercolor Paint Set 12 Colors', 'Faber-Castell watercolor paint set for creative artists. Brand: Faber-Castell. Quantity: 12 colors.', 24, 'https://example.com/faber-castell-watercolor-paint.jpg', 13, 30.00, 40.00, 15, '9012345673901',  '2024-04-15', '2024-04-20'),
    ('Electric Guitar Kit', 'Electric guitar kit for budding musicians. Includes guitar, amp, and accessories.', 25, 'https://example.com/electric-guitar-kit.jpg', 14, 250.00, 300.00, 12, '0123456789012', '2024-04-25', '2024-04-30'),
    ('Nike Basketball Shoes', 'Nike basketball shoes for basketball enthusiasts. Brand: Nike. Sport: Basketball.', 6, 'https://example.com/nike-basketball-shoes.jpg', 17, 350.00, 400.00, 13, '1234567890113',  '2024-05-05', '2024-05-10'),
    ('Sony 65-inch 4K Smart TV', 'Sony 65-inch 4K Smart TV for cinematic viewing. Brand: Sony. Screen Size: 65 inches.', 8, 'https://example.com/sony-65-inch-4k-tv.jpg', 15, 1200.00, 1500.00, 14, '2349678901234', '2024-05-15', '2024-05-20'),
    ('Wrangler Denim Jeans', 'Wrangler denim jeans for rugged style. Brand: Wrangler. Type: Jeans.', 9, 'https://example.com/wrangler-jeans.jpg', 15, 180.00, 220.00, 15, '5456789012345', '2024-05-25', '2024-05-30'),
    ('Modern Wall Art', 'Modern wall art for contemporary home decor. Type: Wall Art. Style: Modern.', 7, 'https://example.com/modern-wall-art.jpg', 16, 80.00, 100.00, 16, '4567895123456',  '2024-06-05', '2024-06-10'),
    ('The Great Gatsby', 'A classic novel by F. Scott Fitzgerald. Genre: Fiction. Author: F. Scott Fitzgerald.', 19, 'https://example.com/the-great-gatsby-book.jpg', 18, 10.00, 15.00, 17, '5678991234567',  '2024-06-15', '2024-06-20'),
    ('LEGO Technic Porsche 911 GT3 RS', 'Build the LEGO Technic Porsche 911 GT3 RS for an authentic building experience. Theme: Sports Car. Brand: LEGO.', 19, 'https://example.com/lego-porsche-911.jpg', 18, 500.00, 600.00, 18, '6789312345678', '2024-06-25', '2024-06-30'),
    ('Wilson Golf Balls 12-pack', 'Wilson golf balls for golf practice and games. Brand: Wilson. Quantity: 12.', 20, 'https://example.com/wilson-golf-balls.jpg', 12, 25.00, 30.00, 19, '7892123456789', '2024-07-05', '2024-07-10'),
    ( 'Shell Engine Oil 4L', 'Shell engine oil for optimal engine performance. Shell brand. Vehicle: Car.', 21, 'https://example.com/shell-engine-oil.jpg', 10, 100.00, 120.00, 20, '8941234567890',  '2024-07-15', '2024-07-20'),
    ( 'Sapphire Ring', 'Elegant sapphire ring for special occasions. Jewelry Type: Ring. Material: Sapphire.', 22, 'https://example.com/sapphire-ring.jpg', 8, 600.00, 700.00, 1, '9012345678901',  '2024-07-25', '2024-07-30'),
    ( 'Copic Sketch Markers 72-set', 'Copic Sketch markers for professional artists. Brand: Copic. Quantity: 72 colors.', 24, 'https://example.com/copic-sketch-markers.jpg', 11, 300.00, 350.00, 2, '4123456789012', '2024-08-05', '2024-08-10'),
    ( 'Fender Stratocaster Electric Guitar', 'Fender Stratocaster electric guitar for musicians. Brand: Fender. Type: Electric.', 25, 'https://example.com/fender-stratocaster-guitar.jpg', 11, 800.00, 1000.00, 3, '1234567890133',  '2024-08-15', '2024-08-20'),
    ( 'LG 75-inch OLED 4K Smart TV', 'LG 75-inch OLED 4K Smart TV for immersive entertainment. Brand: LG. Screen Size: 75 inches.', 8, 'https://example.com/lg-oled-4k-tv.jpg', 16, 1500.00, 1800.00, 4, '2347678901234',  '2024-08-25', '2024-08-30'),
    ( 'Levi''s Denim Jacket', 'Levi''s denim jacket for classic style. Brand: Levi''s. Type: Jacket.', 9, 'https://example.com/levis-denim-jacket.jpg', 16, 200.00, 250.00, 5, '6456789012345', '2024-09-05', '2024-09-10'),
    ( 'Abstract Canvas Painting', 'Abstract canvas painting for modern home decor. Type: Wall Art. Style: Abstract.', 7, 'https://example.com/abstract-canvas-painting.jpg', 17, 100.00, 120.00, 6, '4567898123456',  '2024-09-15', '2024-09-20'),
    ( 'To Kill a Mockingbird Book', 'To Kill a Mockingbird book for classic literature enthusiasts. Genre: Literature. Author: Harper Lee.', 19, 'https://example.com/to-kill-a-mockingbird-book.jpg', 20, 12.00, 15.00, 7, '5678941234567', '2024-09-25', '2024-09-30'),
    ( 'LEGO Architecture Statue of Liberty', 'Build the LEGO Architecture Statue of Liberty for a patriotic experience. Theme: Landmark. Brand: LEGO.', 19, 'https://example.com/lego-statue-of-liberty.jpg', 20, 100.00, 120.00, 8, '6789412345678',  '2024-10-05', '2024-10-10'),
    ( 'Titleist Golf Clubs Set', 'Titleist golf clubs set for golf enthusiasts. Brand: Titleist. Set includes various clubs.', 20, 'https://example.com/titleist-golf-clubs.jpg', 1, 800.00, 1000.00, 9, '7891123456789', '2024-10-15', '2024-10-20'),
    ( 'Mobil 1 Synthetic Motor Oil 5L', 'Mobil 1 synthetic motor oil for high-performance engines. Mobil 1 brand. Vehicle: Car.', 21, 'https://example.com/mobil-1-synthetic-oil.jpg', 2, 120.00, 150.00, 20, '8951234567890', '2024-10-25', '2024-10-30'),
    ( 'Diamond Engagement Ring', 'Elegant diamond engagement ring for special occasions. Jewelry Type: Ring. Material: Diamond.', 22, 'https://example.com/diamond-engagement-ring.jpg', 3, 3000.00, 3500.00, 1, '9012345678101' , '2024-11-05', '2024-11-10')
   ; 
